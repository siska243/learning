import peer from "@/services/peerJs";
...
const RoomPage = () => {
  ...
  const handleQuitRoom = () => {
    // Cleanup code, like stopping streams, disconnecting sockets, etc.
    // Redirect the user to another page or perform necessary actions
  };
